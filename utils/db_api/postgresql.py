...
# add video
    ...
    async def add_video(self, keyword, caption, file_id):
        sql = "INSERT INTO Videos(keyword, caption, file_id) VALUES($1, $2, $3) returning *"
        return await self.execute(sql, keyword, caption, file_id, fetchrow=True)
